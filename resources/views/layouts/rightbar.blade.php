<div class="rightbar">
        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="mobile-logobar">
                    <a href="{{url('/')}}" class="mobile-logo"><img src="{{url('assets/images/small_logo.png')}}" class="img-fluid" alt="logo"></a>
                </div>
                    ...
                    <ul class="list-inline mb-0">
                         ...
                         <li class="list-inline-item">
                            <div class="settingbar">
                                <a href="javascript:void(0)"  class="infobar-icon invisible" >
                            ...
                            <div class="profilebar">
                                <div class="dropdown">
                                  <a class="dropdown-toggle" href="#" role="button" id="profilelink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <span class="username">Hi {{auth()->user()->firstName}},</span>
                                      <img src="{{auth()->user()->getUserImage() ?? url('assets/images/users/profile.svg')}}" class="img-fluid" alt="profile"><span class="feather icon-chevron-down live-icon"></span>
                                  </a>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                        ...
                                        <div class="userbox">
                                            <ul class="list-unstyled mb-0">
                                                <li class="media dropdown-item">
                                                    <a href="{{route('my-profile')}}" class="profile-icon"><img src="{{url('assets/images/svg-icon/user.svg')}}" class="img-fluid" alt="user">My Profile</a>
                                                </li>
                                                {{--
                                                <li class="media dropdown-item">
                                                ...
                                                <li class="media dropdown-item">
                                                    <a onclick="document.forms['logoutForm'].submit()" href="#" class="profile-icon"><img src="{{url('assets/images/svg-icon/logout.svg')}}" class="img-fluid" alt="logout">Log out</a>
    ...
    <div class="footerbar">
        <footer class="footer">
            <p class="mb-0">© 2020 Senska (Private) Limited - All Rights Reserved.</p>
        </footer>
    </div> -->
    <!-- End Footerbar -->
</div>